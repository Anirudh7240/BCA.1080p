        ...
        {selectedMember && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-md glass rounded-2xl p-8 text-center shadow-2xl"
            ...
            >
              ...
              <p className="text-lg text-white/70 uppercase tracking-widest">{selectedMember.role}</p>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
